...
return (
    <div className='flex ml-56 pt-40 max-sm:flex-col max-md:flex-col ' id="about">
    <div className="max-sm:-ml-32 max-sm:px-5">
    ...
    <h2 className='text-gray-300 text-3xl font-bold md:ml-20 max-sm:text-xl max-sm:-ml-20'>
                    ...
                    About Me <hr className=' ml-44 w-56 -mt-4  opacity-40
                     max-sm:ml-32 max-sm:w-32' />

                </h2>
      <p className='max-w-2xl text-gray-400 font-sans text-lg pt-9 pb-5
       pr-14 max-sm:-ml-20 max-sm:max-w-sm max-sm:pr-10 items-center'>Hello! My name is Brittany and I enjoy creating things that live on the internet.
        ...
        <div className='flex text-gray-400 font-mono justify-between w-80 max-sm:flex-row max-sm:-ml-20'>
    <h4>
    ...
    <span> WordPress</span>
      ...
      <div className='h-0 bg-cyan-500 cursor-pointer mb-96
                       max-sm:-ml-32 '>
     <img src={photo} alt="" className="h-80 w-64 rounded-md mt-10 pt-0 border-2 border-green-400 "/>
