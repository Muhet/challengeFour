        ...
        <div className=' mt-28 ml-32 max-sm:ml-24 ' id='work'>
            <div className=' '>
                ...
                font-mono ml-72 text-sm pl-96 space-x-4 pt-3 max-sm:-ml-96 max-sm:-mt-40 maxa-sm:text-md max-sm:sticky'>
                    <a className='ml-20 max-sm:-ml-5 max-sm:gap-x-0'>VS Code</a>
                    <a >Sublime Text</a>
                    <a >Atom</a>
                    <a>iTerm2</a>
                    <a className='max-sm:hidden'>Hyper</a>
                </div>
                ...
                <Cards
                  ...
                  />
                    ...
                    <div className='flex gap-x-4 text-gray-400 font-mono py-4 max-sm:-ml-32 max-sm:-mt-48 md:text-sm'>
                        <a className='max-sm:text-sm max-sm:-ml-6'>React</a>
                        
                        <a className='max-sm:text-sm'>Express</a>
                        <a className='max-sm:text-sm'>Spotify API</a>
                        <a className='max-sm:text-sm'>Heroku</a>
                ...
                <div className=' ml-64 -mt-96 pl-96 max-sm:-ml-32 max-sm:w-10 max-sm:-mt-56'>
                    ...
                    <div className='max-sm:mt-60 max-sm:my-20'>
                    ...
                    <div className='flex font-mono space-x-5 md:text-sm
                     text-gray-400 ml-28 mt-4 max-sm:-ml-80 max-sm:-mt-10 max-sm:sticky'>
                        <a className='max-sm:-ml-3 md:hidden '>React</a>
                        <a>Express</a>
                        <a>Spotify API</a>
                        <a className='max-sm:hidden'>Styled Components</a>


                    </div>
                   
                    <div className='mt-10 ml-32 max-sm:-ml-80 '>
