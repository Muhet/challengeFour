  ...
  return (
    ...
    <div className="ml-44 ">
     <div className=" mt-24  max-w-max max-sm:mt-10 max-sm:-ml-44  ">
        ...
        <li><a onClick={() => updateState('experienceOne')} className="flex items-center p-2 text-base font-normal text-slate-400 rounded-lg  hover:text-emerald-500 hover:bg-emerald-200  ">Upstatement</a></li>
        <li><a onClick={() => updateState('experienceTwo')} className="flex items-center p-2 text-base font-normal text-slate-400 rounded-lg  hover:text-emerald-500 hover:bg-emerald-200 ">Scout</a></li>
        <li><a onClick={() => updateState('experienceThree')} className="flex items-center p-2 text-base font-normal text-slate-400 rounded-lg  hover:text-emerald-500 hover:bg-emerald-200  ">Apple</a></li>
        <li><a onClick={() => updateState('experienceFour')} className="flex items-center p-2 text-base font-normal text-slate-400 rounded-lg  hover:text-emerald-500 hover:bg-emerald-200  ">Scout</a></li>
        <li><a onClick={() => updateState('experienceFive')} className="flex items-center p-2 text-base font-normal text-slate-400 rounded-lg  hover:text-emerald-500 hover:bg-emerald-200  ">Starry</a></li>
        <li><a onClick={() => updateState('experienceSix')} className="flex items-center p-2 text-base font-normal text-slate-400 rounded-lg  hover:text-emerald-500 hover:bg-emerald-200  ">MullenLowe</a></li>
     </ul>
     </div>
     <div className='text-slate-400 pt-7 experience_container max-w-2xl ml-56 -mt-64 max-sm:mt-0 max-sm:-ml-60 ' id='experienceOne'>
     ...
     <div className='experience_container text-slate-400 pt-5 experience_container max-w-xl ml-56 -mt-64 max-sm:mt-0 max-sm:-ml-20' id='experienceTwo'>
     ...
     <div className='experience_container text-slate-400 pt-5 experience_container max-w-xl ml-56 -mt-64 max-sm:mt-0 max-sm:-ml-20' id='experienceThree'>
...
<div className='experience_container text-slate-400 pt-5 experience_container max-w-xl ml-56 -mt-64 max-sm:mt-0 max-sm:-ml-20' id='experienceFour'>
        <div className='space-y-3'>
            <h1 className='text-gray-300 text-2xl font-bold mb-2 max-sm:text-xl'>Studio Developer<span  className='text-emerald-300'> @ Scout</span> </h1>
     ...
     <div className='experience_container text-slate-400 pt-5 experience_container max-w-xl ml-56 -mt-64 max-sm:mt-0 max-sm:-ml-20' id='experienceFive'>
        <div className='space-y-3'>
     ...
     <div className='experience_container text-slate-400 pt-5 experience_container max-w-xl ml-56 -mt-64 max-sm:mt-0 max-sm:-ml-20' id='experienceSix'>
        <div className='space-y-3'>
